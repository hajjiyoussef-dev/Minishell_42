...
int	is_single_builtin_cmd(t_toke *start, t_toke *end)
{
	...
	if (start && is_cmd_buitin(start->str) && (ft_strcmp(start->str, "cd") == 0
			|| ft_strcmp(start->str, "export") == 0 || ft_strcmp(start->str,
				"unset") == 0 || ft_strcmp(start->str, "exit") == 0))
		return (1);
	return (0);
}
...
{
	static char	*buiti[] = {"env", "unset", "export",
		"pwd", "cd", "echo", "exit", NULL};
	int			i;
