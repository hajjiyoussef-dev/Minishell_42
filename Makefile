...
SRC = parsing/lexer.c parsing/shell.c parsing/tools_fun_0.c parsing/syntax.c parsing/expand.c parsing/tools_fun_1.c parsing/copy_env.c parsing/her_doc.c \
		parsing/rediraction.c  parsing/split_word.c parsing/ft_splite.c parsing/concatinate.c parsing/helpe_lexer.c parsing/herdoc_setup.c parsing/help_split_word.c \
		 execution/execution.c  execution/gc_malloc.c   execution/execution_tools.c  execution/ft_strjoin.c  execution/signal/signal.c \
		 execution/builtins/env.c   execution/builtins/pwd.c  execution/builtins/export.c \
